...
def is_valid_word(wordlist, word):
    ...
    True
    >>> is_valid_word(['ANT', 'BOX', 'SOB', 'TO'], 'SOX')
    False
    """
...
def make_str_from_column(board, column_index):
    ...
    for row in board:
        col_str = col_str + row[column_index]
...
def board_contains_word_in_row(board, word):
    ...
    True
    >>> board_contains_word_in_row([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'ANS')
    False
    """
...
def board_contains_word(board, word):
    ...
    True
    >>> board_contains_word([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'SOX')
    False
    """
...
def read_words(words_file):
    ...
    words_rows = words_file.readlines()
...
def read_board(board_file):
    ...
    board_rows = board_file.readlines()

    board = []

    for row in range(len(board_rows)):
        board.append([])
        for char in board_rows[row].strip():
